...
export default function Welcome() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-5 py-12 sm:py-24 text-center">
      <div className="inline-block px-3 py-1 rounded-full bg-slate1 text-xs text-ink/70 mb-5 sm:mb-6">
        ESP32 · Firebase · Real-time
      </div>
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight">
        Control your home, room by room.
      </h1>
      <p className="mt-4 sm:mt-5 leading-relaxed max-w-xl mx-auto text-sm sm:text-base text-ink/70">
